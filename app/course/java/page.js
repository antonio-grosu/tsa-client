        ...
        <div className="flex min-h-screen px-8 bg-neutral-950  poppins gap-24  mt-8 py-36 flex-col  items-center justify-start text-white">
          ...
          <div className="slide-in flex items-center justify-center">
            <div className="md:w-1/2  text-center md:text-left">
              {" "}
              <h1 className="text-3xl font-bold mb-4 ">Java Basics</h1>
              <div className=" p-1  md:hidden  rounded-md my-8  items-center justify-center poppins font-bold text-gray-950 text-xl">
                <img className="w-full" src="/java-logo.svg" />
              </div>
              <p className="text-sm mb-4">
                Delve into Java fundamentals, mastering syntax,{" "}
                <span className="font-bold">
                  {" "}
                  OOP principles, and standard <br /> libraries
                </span>{" "}
                for a well-rounded coding foundation. <br /> Embark on a
                comprehensive journey into the world of Java programming!
                <br />{" "}
              </p>
              <div>
