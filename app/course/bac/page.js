...
function BacCourse() {
  ...
  const lessons = [
    ...
    { id: 7, title: "Exercitii Subiect I" },
    { id: 8, title: "Finalul...deocamdata." },
    { id: 9, title: "C++ If / Else If / Else" },
    { id: 10, title: "C++ Fruit Loops" },
    { id: 11, title: "C++ Fruit Loops 2" },
    { id: 12, title: "Cum ne jucam cu numerele?" },
    { id: 13, title: "Exercitii 1" },
    { id: 14, title: "Pseudocod (Ce poate fi asta ?!)" },
    { id: 15, title: "Structuri de date (Din nou, ce e asta ?!)" },
    { id: 16, title: "Instructiuni si cod" },
    { id: 17, title: "Exercitii 2" },
    { id: 18, title: "Al doilea final." },
    { id: 19, title: "Introducere Subiectul 3" },
    { id: 20, title: "Vectori I" },
    { id: 21, title: "Vectori II" },
    { id: 22, title: "Exercitii Vectori" },
    { id: 23, title: "Subprograme I" },
    { id: 24, title: "Subprograme II" },
    { id: 25, title: "Exercitii Subprograme" },
    { id: 26, title: "Matrici I" },
    { id: 27, title: "Matrici II" },
    { id: 28, title: "Matrici III" },
    { id: 29, title: "Exercitii Matrici" },
    { id: 30, title: "Siruri de caractere I" },
    { id: 31, title: "Siruri de caractere II" },
    { id: 32, title: "Rezolvari concomitente cu citirea" },
    { id: 33, title: "Vectori de frecventa" },
    { id: 34, title: "MARELE ESEU" },
    { id: 35, title: "Finalul finalului" },
  ];
