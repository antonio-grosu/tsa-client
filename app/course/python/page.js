...
function PythonCourse() {
  ...
  const courseId = 1;
  const price = 25;
  const name = "Python Course";
  const description = "Learn Python";
    ...
    <>
      ...
      {!loading && (
        <div className="flex min-h-screen px-8 bg-neutral-950  poppins gap-24  mt-8 py-36 flex-col  items-center justify-start text-white">
          ...
          <div className="slide-in flex items-center justify-center">
            <div className="md:w-1/2  text-center md:text-left">
              {" "}
              <h1 className="text-3xl font-bold mb-4 ">Python Essentials</h1>
              <div className=" p-1  md:hidden  rounded-md my-8  items-center justify-center poppins font-bold text-gray-950 text-xl">
                <img className="w-full" src="/python-logo.svg" />
              </div>
              <p className="text-sm mb-4">
                Delve into the core concepts of Python, covering essential
                functions <br /> and examples for both frontend and backend
                development. Join us <br /> on this hands-on journey to solidify
                your skills in Python programming!
                <br />{" "}
              </p>
              <div>
