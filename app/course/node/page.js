        ...
        <div className="flex min-h-screen px-8  bg-neutral-950  poppins gap-24  mt-8 py-36 flex-col  items-center justify-start text-white">
          ...
          <div className="flex items-center slide-in justify-center">
            <div className="md:w-1/2  text-center md:text-left">
              {" "}
              <h1 className="text-3xl font-bold mb-4 ">NodeJS Fundamentals</h1>
              <div className=" p-1  md:hidden  rounded-md my-8  items-center justify-center poppins font-bold text-gray-950 text-xl">
                <img className="w-full" src="/node-logo.svg" />
              </div>
              <p className="text-sm mb-4">
                Explore the core concepts of{" "}
                <span className="font-bold">Node.js</span>, covering{" "}
                <span className="font-bold">asynchronous programming</span>{" "}
                <br /> and{" "}
                <span className="font-bold">
                  building scalable backend applications
                </span>
                . Through hands-on examples, <br /> build a robust foundation
                for mastering server-side JavaScript development!
                <br />{" "}
              </p>
              <div>
