          ...
          <div className="flex slide-in items-center justify-center">
            <div className="md:w-1/2  text-center md:text-left">
              ...
              <div className=" p-1  md:hidden  rounded-md my-8  items-center justify-center poppins font-bold text-gray-950 text-xl">
                <img className="w-full" src="/js-logo.svg" />
              </div>
              <p className="text-sm mb-4">
                Explore essential JavaScript functions and examples to elevate
                your{" "}
                <span className="font-bold">
                  skills <br /> in both frontend and backend development{" "}
                </span>
                . Join us <br /> for a comprehensive journey into the core of
