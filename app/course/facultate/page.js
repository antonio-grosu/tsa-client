          ...
          <div className="flex slide-in items-center justify-center">
            <div className="md:w-1/2  text-center md:text-left">
              ...
              <h1 className="text-3xl font-bold mb-4 ">
                Ok. Am dat bacul. Acum ce?
              </h1>
              <div className=" p-1  md:hidden  rounded-md my-8  items-center justify-center poppins font-bold text-gray-950 text-xl">
                <img className="w-full" src="/fac-logo.svg" />
              </div>
              <p className="text-sm mb-4">
                Stim cum e. Ai dat bacul, dar acum ai de pregatit admiterea.
                <br />{" "}
                <span className="font-bold"> Vrei tot nota 10 (zece), nu?</span>
              </p>
              <div>
