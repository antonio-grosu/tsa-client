    ...
    <>
      ...
      {!loading && (
        <div className="flex min-h-screen px-8   bg-neutral-950  poppins gap-24  mt-8 py-36 flex-col  items-center justify-start text-white">
          ...
          <div className="flex items-center slide-in justify-center">
            <div className="md:w-1/2  text-center md:text-left">
              {" "}
              <h1 className="text-3xl font-bold mb-4 ">Networks I</h1>
              <div className=" p-1  md:hidden  rounded-md my-8  items-center justify-center poppins font-bold text-gray-950 text-xl">
                <img className="w-full" src="/retelistica-logo.svg" />
              </div>
              <p className="text-sm mb-4">
                Explore the intricacies of computer networks in this
                comprehensive <br /> course, delving into protocols,
                architectures, security, and troubleshooting. <br /> Gain a deep
                understanding of the interconnected world of networking.
                <br />{" "}
              </p>
              <div>
...
export default RetelisticaCourse;
