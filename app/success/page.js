...
function Success() {
  return (
    <div className="bg-neutral-950 py-24 px-8 md:px-24 lg:px-36 xl:px-48 2xl:px-72 min-h-screen flex items-center md:flex-row flex-col justify-center md:justify-between">
      <div className="md:w-1/2 ">
        <h1 className="poppins text-3xl font-bold text-gray-50 mt-8">
          Plata efectuata cu success!
        </h1>
        <div className=" block md:hidden ">
          <img src="/success.svg" className="w-full" />
        </div>
        <p className="poppins text-sm text-gray-50 my-8">
          Contribuția ta face posibilă evoluția și îmbunătățirea continuă a
          serviciilor noastre. Suntem recunoscători pentru încrederea pe care o
          arăți în noi și abordăm cu entuziasm viitorul, avându-te alături.
